...
>(({ children, className, link, ...props }, ref) => {
  ...
  return (
    <button
      ...
      className={cn(
        "group relative w-auto cursor-pointer overflow-hidden rounded-full bg-blue-200 p-2 px-6 text-center font-semibold font-mono border border-solid border-orange-400",
        className,
      )}
      {...props}
    >
